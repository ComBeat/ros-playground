...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dnn_rotate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT dnn_rotate_NUM_DUMMY_TARGETS)
      set(dnn_rotate_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::dnn_rotate::wrapped-linker-option${dnn_rotate_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR dnn_rotate_NUM_DUMMY_TARGETS "${dnn_rotate_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::dnn_rotate::wrapped-linker-option${dnn_rotate_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND dnn_rotate_LIBRARIES "${interface_target_name}")
